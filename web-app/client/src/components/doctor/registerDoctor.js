...
class registerDoctor extends Component {
    ...
    submitForm = async (event) => {
        ...
        if (!errors["medicalRegistrationNo"]) {
            let isMedicalRegistrationNoTaken = localStorage.getItem(this.state.medicalRegistrationNo);
            console.log(isMedicalRegistrationNoTaken);
            if (isMedicalRegistrationNoTaken !== null) {
                errors["medicalRegistrationNo"] = "*medicalRegistrationNo already in use";
            }
        }
