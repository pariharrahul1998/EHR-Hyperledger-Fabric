...
export default function GenerateMedicineReceipt(props) {
    ...
    const [selectedMedicineReceiptFile, setSelectedMedicineReceiptFile] = React.useState('');
    ...
    const uploadLabRecord = async (event) => {
        ...
        try {
            ...
            data.append('file', selectedMedicineReceiptFile, selectedMedicineReceiptFile.name);
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12}>
                                    <Typography align='center'>
                                        {selectedMedicineReceiptFile === '' ? chosenFilename : selectedMedicineReceiptFile.name}
                                    </Typography>
                                </Grid>
