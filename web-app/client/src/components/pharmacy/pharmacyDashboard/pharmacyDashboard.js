...
export default function pharmacyDashboard() {
    ...
    const [generateMedicineReceiptDisplay, setGenerateMedicineReceiptDisplay] = React.useState(false);
    ...
    useEffect(() => {
        const fetchPharmacyData = async () => {
            setLoaded(true);
            try {
                let pharmacyCredentials = JSON.parse(localStorage.getItem('pharmacyToken'));
                ...
                if (!pharmacyCredentials) {
                    ...
                    console.log(pharmacyCredentials);
                    let response = await axios.post(ADDRESS + `readAsset`, pharmacyCredentials);
                    if (response !== null) {
            ...
            <main className={classes.content}>
                ...
                <Container maxWidth="lg" className={classes.container}>
                    ...
                    <Grid container spacing={3} justify='center' alignContent='center'>
                        ...
                        <Grid item xs={12} style={{display: 'none'}} id="generateMedicineReceipt">
