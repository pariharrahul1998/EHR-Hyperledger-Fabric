    ...
    submitForm = async (event) => {
        ...
        if (!isInvalid) {
            ...
            try {
                ...
                console.log(response);
                if (response === "Correct") {
                    localStorage.setItem(this.state.userName, this.state.laboratoryType + ' ' + 'Laboratory');
                    localStorage.setItem(this.state.registrationId, this.state.laboratoryType + ' ' + 'Laboratory');
