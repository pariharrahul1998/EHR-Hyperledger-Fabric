...
export default function laboratoryDashboard() {
    ...
    const [laboratoryInfoDisplay, setLaboratoryInfoDisplay] = React.useState(false);
    const [generateLabRecordDisplay, setGenerateLabRecordDisplay] = React.useState(false);
    ...
    useEffect(() => {
        const fetchLaboratoryData = async () => {
            setLoaded(true);
            try {
                let laboratoryCredentials = JSON.parse(localStorage.getItem('laboratoryToken'));
                ...
                if (!laboratoryCredentials) {
                    ...
                    console.log(laboratoryCredentials);
                    let response = await axios.post(ADDRESS + `readAsset`, laboratoryCredentials);
                    if (response !== null) {
    ...
    const handleLogOut = async () => {
        ...
        try {
            ...
            let response = await axios.post(ADDRESS + `logOut`, laboratoryCredentials);
            response = response.data;
            console.log(response);
            if (response === 'Correct') {
                setLogOut(true);
            ...
            <main className={classes.content}>
                ...
                <Container maxWidth="lg" className={classes.container}>
                    ...
                    <Grid container spacing={3} justify='center' alignContent='center'>
                        ...
                        <Grid item xs={12} style={{display: 'none'}} id="generateLabRecord">
                            {generateLabRecord}
                        </Grid>
